...
//            {
//#warning //TODO: Load Contents
//                JObject jo = new JObject(System.IO.File.ReadAllText(RootSourceFiles[pathRoot]));
//                node = new ObservableNode(pathRoot, null, ObservableNodeTypes.HierarchyOnly);
//            }
//            else
//            {
//#warning //TODO: Create New Contents
//                node = new ObservableNode(pathRoot);
//            }
...
//                var newNode = new ObservableNode(name, childNode);
//                Populate(newNode, ()
//            }
//        }
